...
from utils import load_clay_data  # data functions
...
def main(args):
    ...
    train_dataloader, val_dataloader = load_clay_data(
        dataset_dir, num_episodes, batch_size_train, batch_size_val
    )

    # train_dataloader, val_dataloader, stats, __ = load_data(
